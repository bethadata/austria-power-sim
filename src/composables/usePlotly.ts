...
export function usePlotly() {
  ...
  hydro_river: '#3d3dd3',
  natural_gas: '#fbb078',
  hydro_reservoir_storage_open: '#afc8ff',
  hydro_pumped_storage_open: '#40b0e9',
  biomass: '#3dad62',
  load: '#323232',
  waste: '#7f6444',
  ...
  const namesMap: Record<string, string> = {
    ...
    hydro_reservoir_storage_open: 'Hydro reservoir storage',
    hydro_pumped_storage_open: 'Hydro pumped storage',
    load: "Load",
    biomass: "Biomass",
    waste: "Waste",
